...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [NUM] = LAYOUT_split_3x6_3(
        ...
        XXXXXXX, KC_CIRC, KC_PERC, KC_LABK, KC_RABK, KC_QUES,                               KC_EQL,  KC_LCBR, KC_RCBR, KC_BSLS, KC_ASTR, XXXXXXX,
                                            KC_TAB,  KC_SPC, XXXXXXX,              MO(NAV), KC_ENT,  KC_BSPC
    ),
    ...
    [NAV] = LAYOUT_split_3x6_3(
        ...
        XXXXXXX, KC_F11,  KC_F12, KC_MUTE, KC_VOLD, KC_VOLU,                             KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT, KC_HOME, KC_END,
        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_PSCR, XXXXXXX,                            XXXXXXX, KC_PGDN, KC_PGUP, KC_DEL,   XXXXXXX, XXXXXXX,
